    ...
    public void sendVerificationEmail(User user, String token) {
        ...
        try {
            ...
            String htmlMessage = "<html>" +
                    ...
                    "<p>Thank you for registering with us. Please click the button below to activate your account. This link will expire in <strong>24 hours</strong>.</p>" +
    ...
    public void sendResetPassword(User user, String token)  {
        ...
        try {
            ...
            String htmlMessage = "<html>" +
                    ...
                    "<p>Dear "+ user.getUsername() +",</p>" +
                    "<p>We received a request to reset your password. Please click the button below to reset your password. For security reasons, this link will expire in <strong>10 minutes</strong>.</p>" +
                    "<p style='text-align: center; margin: 20px;'>" +
