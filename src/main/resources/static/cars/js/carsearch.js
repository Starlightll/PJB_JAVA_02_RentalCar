...
function validateTimeInput() {
    ...
    if (pickupDate.getHours() < 5 || pickupDate.getHours() >= 23) {
        pickupInfoHelp.innerHTML = '<i class="fa fa-warning"></i><span> Pickup time must be in range of 5:00 - 23:00</span>';
        return false;
    }
    if (dropDate.getHours() < 5 || dropDate.getHours() >= 23) {
        pickupInfoHelp.innerHTML = '<i class="fa fa-warning"></i><span> Drop time must be in range of 5:00 - 23:00</span>';
        return false;
    }
    const diffHours = (dropDate - pickupDate) / 1000 / 60 / 60;
    if (diffHours < 2) {
