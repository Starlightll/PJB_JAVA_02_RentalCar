$(function () {
    ...
    a.length && (e = a.DataTable({
        ...
        columnDefs: [{
            ...
            targets: 2, responsivePriority: 4, render: function (e, t, a, s) {
                var n = a.project_img, r = a.project_name, l = a.date;
            ...
            targets: 4, orderable: !1, searchable: !1, render: function (e, t, a, s) {
            ...
            targets: -1, searchable: !1, title: "Action", orderable: !1, render: function (e, t, a, s) {
        ...
        columnDefs: [{
            className: "control", responsivePriority: 2, targets: 0, render: function (e, t, a, s) {
                return ""
            }
        }, {
            targets: 1, searchable: true, render: function (e, t, a, s) {
                return '<a href="app-invoice-preview.html"><span>#' + a.invoice_id + "</span></a>"
            }
        }, {
            targets: 2, render: function (e, t, a, s) {
                var n = a.invoice_status, r = a.due_date;
        ...
        <"col-sm-6 col-12 d-flex align-items-center justify-content-center justify-content-sm-start mt-6 mt-sm-0"
            f
        >
        <"col-sm-6 col-12 d-flex justify-content-center justify-content-md-end align-items-baseline"
            <"dt-action-buttons d-flex justify-content-center flex-md-row align-items-baseline gap-4"
                lB
            >
        >
        >
        t
        <"row mx-6"
        <"col-sm-12 col-xxl-6 text-center text-xxl-start pb-md-2 pb-xxl-0"
            i
        >
        <"col-sm-12 col-xxl-6 d-md-flex justify-content-xxl-end justify-content-center d-flex"
            p
        >
        >
        `,
